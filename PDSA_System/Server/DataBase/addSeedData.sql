-- Bruker
INSERT INTO NordicDoor.Bruker (BrukerId, Fornavn, Etternavn, Email, PassordHash, Opprettet, Rolle, LederId) VALUES (1, 'Tobias', 'Hansen', 'tob@mail.com', 'OTOiYdFITlCQGxI+/MGSUO3MGmK46v8LV45DgHFVHNg=:T4sen2e7YnMALZpNRTz5dQJfcg/RZBhnpxVKR2donyg=', '2022-10-10 10:19:40', 'teamleder', 1);
INSERT INTO NordicDoor.Bruker (BrukerId, Fornavn, Etternavn, Email, PassordHash, Opprettet, Rolle, LederId) VALUES (2, 'Siddharth', 'Dushantha', 'satan@sidd.no', '02BNAhz1nQOV6Rrdoyalqyug9xh5mJlWmUxgXerpO74=:2k5s/T2rgp0e8vB75+a9fhtUbQFWeWIanwgP/mEqy34=', '2022-10-01 23:25:21', 'ansatt', 2);
