...
CREATE TABLE IF NOT EXISTS TeamMedlemskap(
  ...
  CONSTRAINT FK_LagMedlemskap_Lag FOREIGN KEY (TeamId) REFERENCES Team(TeamId) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT FK_LagMedlemskap_Bruker FOREIGN KEY (TeamId) REFERENCES Bruker(TeamId)
);
